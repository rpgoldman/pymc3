...
class BaseStochasticGradient(ArrayStepShared):
    ...
    def __init__(self, vars: Optional[Any] = ..., batch_size: Optional[Any] = ..., total_size: Optional[Any] = ..., step_size: float = ..., model: Optional[Any] = ..., random_seed: Optional[Any] = ..., minibatches: Optional[Any] = ..., minibatch_tensors: Optional[Any] = ..., **kwargs: Any) -> None: ...
...
class SGFS(BaseStochasticGradient):
    ...
    B: Any = ...
    step_size_decay: Any = ...
    def __init__(self, vars: Optional[Any] = ..., B: Optional[Any] = ..., step_size_decay: int = ..., **kwargs: Any) -> None: ...
    avg_I: Any = ...
    t: Any = ...
    gamma: Any = ...
    training_fn: Any = ...
